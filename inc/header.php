...
<link rel="stylesheet" type="text/css" href="<?= $url->icomoon("icomoon.css"); ?>">
...
<link rel="stylesheet" type="text/css" href="<?= $url->home("style.css"); ?>">
      ...
      <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
        ...
        <div class="offcanvas-body justify-content-between">
          ...
          <ul class="d-flex  align-items-center list-unstyled m-0">
            <li class="nav-item dropdown">
                <a href="../admin/profile.php" class="nav-link mx-2 dropdown-toggle align-items-center" role="button" id="shop"
                  data-bs-toggle="dropdown" aria-expanded="false">Welcome <?= $_SESSION['user']['firstname']; ?></a>
                <ul class="dropdown-menu" aria-labelledby="shop">
                  <li><a href="<?= $url->admin('profile.php')?>" class="dropdown-item">User Profile</a></li>
                  <li><a href="<?= $url->home('logout.php')?>" class="dropdown-item">Logout</a></li>
                </ul>
            </li>
          </ul>
          <?php else: ?>
